        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, "Live music performances", "Concert" },
                    { 4, "Training and educational workshops", "Workshop" },
                    { 5, "Social gatherings and celebrations", "Party" },
                    { 6, "Art and trade exhibitions", "Exhibition" }
                });
